...
const Admin = require('../model/admin'); // Adjust path as per your project structure
...
router.get('/delete/:id', async (req, res) => {
    try {
        ...
        const admin = await Admin.findByIdAndDelete(id).exec(); // Changed to findByIdAndDelete
        if (admin.image) {
            try {
